...
<div class="container-fluid">
	...
	{{ Form::open(array("class" => "form-horizontal", "id" => "settings-form", "url" => action('SettingsController@saveSettings'), "method" => "post")) }}
	...
	{{ Form::open(array("class" => "form-horizontal", "id" => "password-form", "url" => action('SettingsController@changePassword'), "method" => "post")) }}
