...
<div class="container-fluid">
	...
	<div class="row">
		...
		<div class='col-sm-6'>
			...
			<table class="table">
				<tr>
					<th><a href="{{url()}}/logs/{{$yr}}-01-01/{{$yr}}-01-31/">January</a></th>
					<td>{{{$monthly_totals[0]}}}</td>
				</tr>
				<tr>
					<th><a href="{{url()}}/logs/{{$yr}}-02-01/{{$yr}}-02-29/">February</a></th>
					<td>{{{$monthly_totals[1]}}}</td>
				</tr>
				<tr>
					<th><a href="{{url()}}/logs/{{$yr}}-03-01/{{$yr}}-03-31/">March</a></th>
					<td>{{{$monthly_totals[2]}}}</td>
				</tr>
				<tr>
					<th><a href="{{url()}}/logs/{{$yr}}-04-01/{{$yr}}-04-30/">April</a></th>
					<td>{{{$monthly_totals[3]}}}</td>
				</tr>
				<tr>
					<th><a href="{{url()}}/logs/{{$yr}}-05-01/{{$yr}}-05-31/">May</a></th>
					<td>{{{$monthly_totals[4]}}}</td>
				</tr>
				<tr>
					<th><a href="{{url()}}/logs/{{$yr}}-06-01/{{$yr}}-06-30/">June</a></th>
					<td>{{{$monthly_totals[5]}}}</td>
				</tr>
				<tr>
					<th><a href="{{url()}}/logs/{{$yr}}-07-01/{{$yr}}-07-31/">July</a></th>
					<td>{{{$monthly_totals[6]}}}</td>
				</tr>
				<tr>
					<th><a href="{{url()}}/logs/{{$yr}}-08-01/{{$yr}}-08-31/">August</a></th>
					<td>{{{$monthly_totals[7]}}}</td>
				</tr>
				<tr>
					<th><a href="{{url()}}/logs/{{$yr}}-09-01/{{$yr}}-09-30/">September</a></th>
					<td>{{{$monthly_totals[8]}}}</td>
				</tr>
				<tr>
					<th><a href="{{url()}}/logs/{{$yr}}-10-01/{{$yr}}-10-31/">October</a></th>
					<td>{{{$monthly_totals[9]}}}</td>
				</tr>
				<tr>
					<th><a href="{{url()}}/logs/{{$yr}}-11-01/{{$yr}}-11-30/">November</a></th>
					<td>{{{$monthly_totals[10]}}}</td>
				</tr>
				<tr>
					<th><a href="{{url()}}/logs/{{$yr}}-12-01/{{$yr}}-12-31/">December</a></th>
					<td>{{{$monthly_totals[11]}}}</td>
				</tr>
				<tr>
					<th><a href="{{url()}}/logs/{{$yr}}-01-01/{{$yr}}-12-31/">2016</a></th>
